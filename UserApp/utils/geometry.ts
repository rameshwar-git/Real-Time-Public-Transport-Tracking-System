...
/**
 * Reject 0,0 / NaN / missing coordinates — prevents Google Maps NOT_FOUND errors.
 */
export const isValidCoord = (c: any): boolean =>
    c != null &&
...
export const calculateRouteMatch = (
    ...
    // Match if: destinations are close (>10%) OR detour is small OR heading same direction with close destinations
